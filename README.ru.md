...
- Упавший туннель отправляет своих клиентов в WAN (на Merlin этого не будет, если у VPN-клиента прошивки включён killswitch). Web UI и бот спрашивают подтверждение, прежде чем перенести клиента на упавший туннель или на туннель, которого роутер не знает.
